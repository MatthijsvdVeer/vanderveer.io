...
![Screenshot the Azure Portal, creating an IoT Hub](/assets/blog/iot-hub-service-managed-identity/create-iot-hub.png "Bye-bye policies!")

When the deployment is complete, you can go to the shared access policies blade and verify that the policies are disabled.

![Screenshot that shows the access policies are disabled](/assets/blog/iot-hub-service-managed-identity/policies-disabled.png "The policies are disabled")
...
![Screenshot of an Azure Function with a system-assigned identity](/assets/blog/iot-hub-service-managed-identity/identity-created.png "No more identity crisis")
...
![Screenshot of a role assignment in the making](/assets/blog/iot-hub-service-managed-identity/add-role-assignment.png "Assigning a role")
