...
![Floor Plan](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/floor_plan.jpg "Floor plan of The Office.")
...
![Unconnected Nodes](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/nodes.png "Unconnected Nodes") 
...
![Creating relationships](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/relationship.png "Creating relationships")

After creating the relationships between the areas and the floor, this is what I ended up with:

![Basic graph](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/graph-basic.png "Basic graph")

Adding all the desks and the relationships to the different areas gave me this result:

![Extended graph](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/graph-extended.png "It's just a tree structure visualised creatively")
...
![Excel twins](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/excel-file.png "Who doesn't love a good table?")
...
![Reservation](/assets/blog/back-to-the-office-with-azure-digital-twins-part-2/reservation.png "Desk, reservation, employee")
