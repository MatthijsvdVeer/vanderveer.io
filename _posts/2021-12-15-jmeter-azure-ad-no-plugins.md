...
![Screenshot the Azure Portal, creating an App Service](/assets/blog/jmeter-azure-ad-no-plugins/create-app-service.png "Creating an App Service")
...
![Screenshot the Azure Portal, opening the Authentication blade](/assets/blog/jmeter-azure-ad-no-plugins/select-easy-auth.png "Open the Authentication blade")
...
![Screenshot the Azure Portal, enabling authentication](/assets/blog/jmeter-azure-ad-no-plugins/create-app-registration.png "Enabling authentication")
...
![Screenshot the Azure Portal, show the application registration authentication](/assets/blog/jmeter-azure-ad-no-plugins/copy-tenant-and-application.png "The application registration")
...
![Screenshot the Azure Portal, showing the creation of a secret](/assets/blog/jmeter-azure-ad-no-plugins/create-secret.png "Sssssshhh")

Copy the secret Value (do it now, you won't see it later).

![Screenshot the Azure Portal, showing the client secrets](/assets/blog/jmeter-azure-ad-no-plugins/copy-client-secret.png "Keep it secret, keep it safe")
...
![JMeter screenshot, showing the variables](/assets/blog/jmeter-azure-ad-no-plugins/jmeter-user-defined-variables.png "User Defined Variables")
...
![JMeter screenshot, showing the variables](/assets/blog/jmeter-azure-ad-no-plugins/stage-1-test-setup.png "User Defined Variables")
...
![JMeter screenshot, showing the access-token](/assets/blog/jmeter-azure-ad-no-plugins/access-token.png "One access token, coming right up!")
...
![JMeter screenshot, showing the HTTP request to the site](/assets/blog/jmeter-azure-ad-no-plugins/http-request-to-site.png "Setting up the final request")

With all of this set up, run the test again and see the output of the View Results Tree!

![JMeter screenshot, showing the HTTP request is successful](/assets/blog/jmeter-azure-ad-no-plugins/results.png "Success! Render it in your brain!")
