...
![Glass award flashing brightly](/assets/blog/no-code-notifications-iot-central/flashy.gif  "Disco disco, good good")
...
![Screenshot of the device template](/assets/blog/no-code-notifications-iot-central/device-template.png "The device template")
...
![Screenshot of the Logic App](/assets/blog/no-code-notifications-iot-central/logic-app.png "The Logic App")
...
![Screenshot of the Logic App node for IoT Central](/assets/blog/no-code-notifications-iot-central/iot-central-node.png "Execute")
...
![Picture of LEDs](/assets/blog/no-code-notifications-iot-central/LEDs.jpg "The front (AKA the side that looks good)")
...
![Picture of the 3D model](/assets/blog/no-code-notifications-iot-central/base.png "I can only design rectangles")
...
![Screenshot of the Node-Red flow](/assets/blog/no-code-notifications-iot-central/flow.png "No code necessary.")
